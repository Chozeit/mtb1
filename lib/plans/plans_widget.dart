          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<List<MealplanRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<MealplanRecord> listViewMealplanRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      ...
                      itemCount: listViewMealplanRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewMealplanRecord =
                            listViewMealplanRecordList[listViewIndex];
                        return Padding(
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'mealplanRef': serializeParam(
                                    listViewMealplanRecord.reference,
