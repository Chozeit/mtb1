      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => PlandetailsWidget(
            mealplanRef: params.getParam('mealplanRef',
                ParamType.DocumentReference, false, ['mealplan']),
          ),
        ),
        FFRoute(
          name: 'menu',
        ...
        FFRoute(
          name: 'buynowplans',
          path: '/buynowplans',
          builder: (context, params) => BuynowplansWidget(
            planRef: params.getParam('planRef', ParamType.DocumentReference,
                false, ['mealplan', 'plans']),
          ),
        ),
        FFRoute(
          name: 'cartView',
          path: '/cartView',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'cartView')
              : CartViewWidget(),
        ),
        FFRoute(
          name: 'checkout',
