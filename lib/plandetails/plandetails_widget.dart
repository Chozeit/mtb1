...
class PlandetailsWidget extends StatefulWidget {
  const PlandetailsWidget({
    super.key,
    required this.mealplanRef,
  });

  final DocumentReference? mealplanRef;
...
class _PlandetailsWidgetState extends State<PlandetailsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MealplanRecord>(
      stream: MealplanRecord.getDocument(widget.mealplanRef!),
      builder: (context, snapshot) {
        ...
        final plandetailsMealplanRecord = snapshot.data!;
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        plandetailsMealplanRecord.image,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          plandetailsMealplanRecord.name,
                          style: FlutterFlowTheme.of(context).headlineMedium,
                        ),
                        Text(
                          'Description',
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return InkWell(
                                  ...
                                  //     'plandetails',
                                  //     queryParameters: {
                                  //       'mealplanRef': serializeParam(
                                  //         plandetailsMealplanRecord.reference,
