...
import 'menuitems_model.dart';
export 'menuitems_model.dart';
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<List<RestaurantRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<RestaurantRecord> listViewRestaurantRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      ...
                      itemCount: listViewRestaurantRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewRestaurantRecord =
                            listViewRestaurantRecordList[listViewIndex];
                        return Padding(
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'restaurantRef': serializeParam(
                                    listViewRestaurantRecord.reference,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          listViewRestaurantRecord.image,
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
                                        ),
